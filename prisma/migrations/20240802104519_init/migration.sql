...
-- DropForeignKey
ALTER TABLE `DailyVolume` DROP FOREIGN KEY `DailyVolume_poolId_fkey`;
...
CREATE TABLE `pools` (
    ...
    UNIQUE INDEX `pools_account_key`(`account`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `AuctionSlot` ADD CONSTRAINT `AuctionSlot_poolId_fkey` FOREIGN KEY (`poolId`) REFERENCES `pools`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `LPTokenBalance` ADD CONSTRAINT `LPTokenBalance_poolId_fkey` FOREIGN KEY (`poolId`) REFERENCES `pools`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `VoteSlot` ADD CONSTRAINT `VoteSlot_poolId_fkey` FOREIGN KEY (`poolId`) REFERENCES `pools`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `daily_volume` ADD CONSTRAINT `daily_volume_poolId_fkey` FOREIGN KEY (`poolId`) REFERENCES `pools`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
