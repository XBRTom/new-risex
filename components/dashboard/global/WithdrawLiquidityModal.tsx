...
export default function WithdrawLiquidityModal({ pool, closeModal }: WithdrawLiquidityModalProps) {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <Card className="bg-gradient-to-br from-gray-900 to-black border-gray-800 shadow-lg rounded-xl overflow-hidden z-10">
            <CardContent className="p-6">
              ...
              <p className="text-gray-300">Liquidity withdrawn successfully!</p>
              <button
